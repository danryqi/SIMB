...
<body>
    <div class="header mb-0">
        ...
        <div style="background-color: #f9f7e4;" class="content mt-0 pt-3">
            <div class="container">
                <div class="card card-register mt-2">
                <center>
                    <h3 class="mt-4">Register</h3>
                    <span style="font-size: 16px; font-weight:400; color:#122d4f; font-style: italic;">
                ...
                <div class="card-body">
                    <form method="POST" action="clogin.php">
                        ...
                        <center class="mt-4">
                            <button type="submit" class="btn btn-primary" style="width: 49%;" name="register">Register</button>
                        </center>
                    </form>
                </div>
            </div>
